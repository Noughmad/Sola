...
\begin{figure}[h]
 \centering
 \vspace{-1.2cm}
 \includegraphics[width=.8\textwidth]{g_refraction_test}
 \vspace{-1.4cm}
...
\begin{figure}[!ht]
\centering
  \begin{overpic}[width=.4\textwidth]{./Rezultati/lic_p1_0_lin}\put(2,90){\color{white} \Large \bf (a)}\end{overpic} \hspace{1mm}
  \begin{overpic}[width=.4\textwidth]{./Rezultati/lic_p1_37_rad}\put(2,90){\color{white} \Large \bf (b)}\end{overpic} \\[3mm]
  \begin{overpic}[width=.4\textwidth]{./Rezultati/lic_p1_51_p2}\put(2,90){\color{white} \Large \bf (c)}\end{overpic} \hspace{.5mm}
  \begin{overpic}[width=.4\textwidth,trim=-1cm -1cm -1cm -1cm]{g_defect_2}\put(2,90){\Large \bf (d)}\end{overpic}
...
\begin{figure}[!ht]
\centering
  \begin{overpic}[width=.4\textwidth]{./Rezultati/lic_m1_0_lin}\put(2,90){\color{white} \Large \bf (a)}\end{overpic} \hspace{1mm}
  \begin{overpic}[width=.4\textwidth]{./Rezultati/lic_m1_37_hyp}\put(2,90){\color{white} \Large \bf (b)}\end{overpic} \\[3mm]
  \begin{overpic}[width=.4\textwidth]{./Rezultati/lic_m1_51_m2}\put(2,90){\color{white} \Large \bf (c)}\end{overpic} \hspace{.5mm}
...
\begin{figure}[!ht]
\centering
  \begin{overpic}[width=.4\textwidth]{./Rezultati/lic_p12_0_lin}\put(2,90){\color{white} \Large \bf (a)}\end{overpic} \hspace{1mm}
  \begin{overpic}[width=.4\textwidth]{./Rezultati/lic_p12_83_rad_n2}\put(2,90){\color{white} \Large \bf (b)}\end{overpic} \\[3mm]
  \begin{overpic}[width=.4\textwidth]{./Rezultati/lic_p12_5325_rad}\put(2,90){\color{white} \Large \bf (c)}\end{overpic} \hspace{.5mm}
  \begin{overpic}[width=.4\textwidth,trim=-1cm -1cm -1cm -1cm]{g_defect_1}\put(2,90){\Large \bf (d)}\end{overpic}
...
\begin{figure}[!ht]
\centering
  \begin{overpic}[width=.4\textwidth]{./Rezultati/lic_m12_0_lin}\put(2,90){\color{white} \Large \bf (a)}\end{overpic} \hspace{1mm}
  \begin{overpic}[width=.4\textwidth]{./Rezultati/lic_m12_37}\put(2,90){\color{white} \Large \bf (b)}\end{overpic} \\[3mm]
  \begin{overpic}[width=.4\textwidth]{./Rezultati/lic_m12_50}\put(2,90){\color{white} \Large \bf (c)}\end{overpic} \hspace{.5mm}
  \begin{overpic}[width=.4\textwidth,trim=-1cm -1cm -1cm -1cm]{g_defect_-1}\put(2,90){\Large \bf (d)}\end{overpic}
  \caption{Posnetki elektri"cnega polja na razli"cnih mestih znotraj vlakna z direktorskim profilom z defektom mo"ci $-1/2$ ob stalni osvetlitvi. 
  Vidno je izmenjevanje konfiguracij z ovojnimi "stevili $s=0$ (a), $s=-1/2$ (b) in $s=-1$ (c). 
  Z belo barvo so prikazane silnice elektri"cnega polja, njihova svetlost pa je sorazmerna z intenziteto svetlobe. 
  Rde"ce pu"s"cice prikazujejo trenutno elektri"cno polje. 
