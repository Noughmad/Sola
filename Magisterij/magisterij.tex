...
V odsotnosti zunanjih polj je to ureditev z uniformnim direktorjem, kjer je celotna elasti"cna prosta energija enaka 0. 
...
Tak"snim obmo"cjem, kjer orientacijski red ne dr"zi, pravimo defekti oz. natan"cneje disklinacije. 

V treh dimenzijah lahko obstajajo to"ckasti in linijski defekti. 
...
Zanima nas zlasti, za koliko se obrne direktorsko polje, "ce defekt obkro"zimo. 
...
\begin{figure}[h]
 ...
 \caption{Nekaj mo"znih linijskih defektov. Mo"c defekta je odvisna od tega, kolikokrat se zavrti direktor (temno modre "crte), ko naredimo en krog po svetlo modrem krogu. Od leve proti desni so mo"ci 1, $-1$, $1/2$ in $-1/2$. }
\end{figure}

Definiramo lahko topolo"ski naboj oz. mo"c defekta kot

\begin{align}
 q = \frac{1}{2\pi}\int_0^{2\pi} \left(\frac{d\theta}{d\phi}\right) \dd \phi
\end{align}

Direktorsko polje je zvezno povsod razen v defektu, zato mora direktor pri $\phi = 0$ enak kot pri $\phi = 2\pi$. 
Ta pogoj dolo"ca mo"zne vrednosti za $q$. 

Za prava vektorska polja mora biti $q$ celo "stevilo. 
Nematski direktor pa imam dodatno simetrijo, saj stanji $\vec n$ in $-\vec n$ predstavljata enak red. 
Zato je mo"zno, da pri obkro"zenju defekta direktor naredi le pol obrata. 
Topolo"ski naboj $q$ je zato lahko tudi polcelo "stevilo. 

\todo{Opis defektov v nematskem direktorju} \\
\todo{Opis defektov v polarizaciji svetlobe} \\
\todo{Povezava med obema}
