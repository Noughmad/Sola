...
Za prikaz delovanja sem zato uporabil vpadni kot, ki je enak Brewsterjevemu. 
...
\begin{figure}[h]
\centering
\resizebox{.7\textwidth}{!}{\input{g_test_uniform}}
...
\begin{figure}[!htbp]
\centering
\resizebox{.7\textwidth}{!}{\input{g_test_periodic}}
...
Zaradi jasnosti smo uporabili vlakno z ni"zjo dvolomnostjo kot v pulznem na"cinu; tu je bila razlika med izrednim in rednim lomnim koli"cnikom le $\Delta n = 0,\!04$. 
Zna"cilno dol"zino pojavov v dvolomnem vlaknu lahko ocenimo kotNa ta na"cin je bila zna"cilna dol"zina pojavov
\begin{align}
