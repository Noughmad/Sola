...
\begin{align}
 \frac{1}{\tau} \approx \frac{f_\mathrm{el} + f_\mathrm{EM}}{\gamma_1}\,.
\end{align}
...
% za v KRunner: 0.06 Pas / (6*10^(-12)N / (1um)^2 + 8.86*10^(-12) As/Vm * 0.5 * (3V/um)^2 ) =
 \tau \approx \frac{\gamma_1}{K/l^2 + \varepsilon_0 \varepsilon_a^{\mathrm{mol}} E^2 } \approx 1\;\mathrm{ms}\,.
\end{align}
kjer je $\gamma_1$ rotacijska viskoznost. 
Pri vrednosti viskoznosti, elasti"cne konstante in dielektri"cne anizotropije za 5CB \cite{diploma-miha,kolicniki} in jakosti elektri"cnega polja $E = 1\mathrm{V}/\mu\mathrm{m}$, tipi"cni za opti"cne pincete, relaksacijski "cas zna"sa pribli"zno 1 ms \cite{diploma-miha}. 
...
Teko"cekristalna vlakna na osnovi sklenjenih smekticnih A slojev, ki so jih nedavno izdelali v laboratorijih prof I. Mu"sevi"ca (IJS) in prof. C. Bahra (Max Planck Institut for Fluid Dynamics), imajo radialne direktorske profile \cite{peddireddy}. 
