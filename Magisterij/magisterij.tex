...
\begin{figure}[!htbp]
 \centering
 \includegraphics[width=.8\textwidth]{./Slike/defekt-kapljica}
...
\begin{figure}[!htbp]
 \centering
 \includegraphics[width=.8\textwidth]{./Slike/defekt-array-postavitev}
 \includegraphics[width=.8\textwidth]{./Slike/defekt-array-brasselet}
...
\begin{align}
 E_\alpha|_{i,j,k}^{n+1} &= E_\alpha|_{i,j,k}^n + \Delta t \cdot (\varepsilon^{-1})_{\alpha\beta} (\nabla\times H)_\beta|_{i-1,j-1,k-1}^{n} \label{eq:disk-E}\\
