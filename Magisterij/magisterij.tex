...
\begin{figure}[h]
 ...
 \begin{overpic}[width=.9\textwidth]{g_refraction_test}
  ...
  \put(25,50){\line(1,-2){15}}
  \put(44,29.5){\vector(3,1){16}}
  \put(37,27.6){$\boldsymbol\alpha$}
  \put(53,30){$\boldsymbol\beta$}
 \end{overpic}
 \vspace{-1.4cm}
...
\begin{align}
 \beta &= \arcsin \left(\frac{n_1}{n_2} \sin \alpha \right) = \arcsin \left( \frac{1}{3,\!41} \times \sin 16\degree \right) \approx 4,\!7\degree
\end{align}
...
Slika je zaradi jasnej"sega prikaza raztegnjena v vodoravni smeri, tako da se la"zje vidi oblika valov, koti na sliki pa niso pravilni. 
