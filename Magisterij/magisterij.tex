...
\begin{figure}[h]
 ...
 \begin{overpic}[width=.45\textwidth]{g_test_plane}
  ...
  \put(-10,35){\color{white} \hdashrule{0.7\textwidth}{3pt}{16pt}}
 \end{overpic} \,
...
\begin{figure}[h]
 ...
 Barva predstavlja lokalno elektri"cno polje, pu"s"cice pa smer "sirjena valovanja. 
