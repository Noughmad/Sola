...
Imajo pa red dolgega dosega v orientaciji gradnikov. 

Dvolomnost teko"cih kristalov izvira iz orientacijskega reda. 
...
Za opis delno polarizirane svetlobe potrebujemo Stokesove vektorje, ki so posplo"sitev Jonesoving in imajo "stiri komponente, naprave pa so opisane z Muellerjevimi matrikami velikosti $4\times 4$.
Vse te metode uporabljajo mo"cno poenostavljen opis svetlobe. 
...
Tak"sen pristop je ra"cunsko mnogo bolj zahteven, omogo"ca pa modeliranje "sirjenja svetlobe po poljubno zapletenih strukturah. 
...
Metoda temelji na direktnem "casovnem razvoju elektromagnetnih polj po Maxwellovih ena"cbah. 
...
V kiralnem nematiku oz. holesteriku ima stanje z najni"zjo prosto energijo konstanten zvoj s periodo $a = 2\pi / q$.
...
Za razliko od direktorskega polja v teko"cih kristalih pa deformacije elektromagnetnih polj ne nosijo energije, zato so stabilne poljubne konfiguracije. 
...
Pomembna lastnost obeh zgornjih ena"cb je, da med ra"cunanje enega izmed polj potrebujemo le vrednosti drugega polja, ne pa tudi istega polja na sosednjih mesti. 
...
Ker nastopa pri "casovnem odvodu elektri"cnega polja, mora biti podan na istem mestih kot $E_\alpha$, torej v to"ckah s celo"stevilskimi koordinatami. 
