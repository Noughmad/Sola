...
Kot obi"cajno pri re"sevanju ena"cb si jo najprej poenostavimo tako, da preidemo na brezdimenzijske spremenljivke in "cimbolj minimiziramo "stevilo parametrov. Izberimo si meri za dol"zino $x_0$ in hitrost $v_0$. "Ce uvedemo "se brezdimenzijsko Reynoldsovo "stevilo $R=v_0 x_0 / \mu$, lahko ena"cbo za"pi"semo za brezdimenzijski spremenljivki $U$ in $P$. 
...
\begin{equation}
 || u'(\vec r, 0) ||, \; || p'(\vec r, 0) || < \delta
\end{equation}
velja
\begin{equation}
 || u'\rt ||, \; || p'\rt || < \eps \;\;\;\; \forall t > 0
\end{equation}
