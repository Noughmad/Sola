...
kjer je $\mu$ viskoznost teko"cine, $\rho$ njena gostota, $\sigma$ povr"sinska napetost, $2a$ pa povpre"cna debelina opne pred razpadom. "Casovno spreminjanje roba pri razli"cnih vrednosti $Z$ je prikazano na sliki~\ref{fig:mehurcek-rez-vis-1}

\begin{figure}[h]
  \centering
\includegraphics[width=.85\textwidth]{./Slike/scat-rezultat-1}
...
\begin{figure}[h]
\centering
 \includegraphics[width=.7\textwidth]{./Slike/Zlebici}
...
\begin{figure}[h]
 \centering
 \subfigure{\includegraphics[height=.7\textwidth]{./Slike/zlebici-profil}}
 \subfigure{\includegraphics[height=.7\textwidth]{./Slike/zlebici-slika}}
